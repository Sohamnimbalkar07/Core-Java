...
2. java.util.GregorianCalendar extends Calendar
month range --- 0-11
...
Must be last arg in the method args.
...
ref.doStuff2('A');//no err
ref.doStuff2('A',new int[] {3,4,5});//no err
ref.doStuff2('A',3,4,5);//no err
