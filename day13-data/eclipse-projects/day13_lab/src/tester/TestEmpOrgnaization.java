...
public class TestEmpOrgnaization {
	...
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			while (!exit) {
				System.out.println(
						"Options 1. Hire Emp 2. Display All Emps details 3.Update Emp Details 4. Link Adhar Card "
								+ "5.Display Specific Emp Details 6.Delete Emp Info 7. Display names joined after 8. Sort emps as per emp id 10.Exit");
...
//							System.out.println(e1);
					...
					case 7:
						...
						break;
					case 8://sort the emps as per asc order of emp id
						System.out.println("Sorted emp list");
						Collections.sort(empList);//Natural ordering
						break;
					case 9://sort the emps as per last name
						//1 :  create instance of the class that imple. Comparator
