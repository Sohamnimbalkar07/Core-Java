...
public class CollectionUtils {
	...
	public static HashMap<Integer, BankAccount> populateMap() {
		...
		// customerName
		System.out.println("added : put " + map.put(10, new BankAccount(10, LOAN, 5000, parse("2010-04-23"), "Reema")));
		System.out.println(
				"added : put " + map.put(101, new BankAccount(101, CURRENT, 3500, parse("2011-06-21"), "Sameer")));

		System.out
				.println("added : put " + map.put(76, new BankAccount(76, LOAN, 150000, parse("2009-04-01"), "Mohan")));
	...
	// add a static method to copy bank accounts from Map --> ArrayList
	public static ArrayList<BankAccount> populateList(HashMap<Integer, BankAccount> map) {
		ArrayList<BankAccount> list = new ArrayList<>();
		//imeprative style of prog : non func style of prog
//		for (BankAccount a : map.values())
//			list.add(a);
		//replace it by declarative style of prog : functional prog
